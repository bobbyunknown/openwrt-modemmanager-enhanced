...
return network.registerProtocol('modemmanager', {
	...
	renderFormOptions: function(s) {
		...
		o = s.taboption('advanced', form.Flag, 'force_connection', _('Force connection'),
			_('Automatically retry connection on registration or connection failures instead of blocking interface restart.'));
